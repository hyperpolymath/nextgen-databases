...
Golden test vectors in `test-vectors/gql/`:

* `parse_insert.gql` + `parse_insert.ast` - Insert parsing
* `parse_select.gql` + `parse_select.ast` - Select parsing
* `parse_edge.gql` + `parse_edge.ast` - Edge traversal parsing
* `execute_insert.gql` + `execute_insert.result` - Insert execution
* `execute_select.gql` + `execute_select.result` - Select execution
* `error_constraint.gql` + `error_constraint.result` - Constraint error
...
* link:gql-philosophy.adoc[GQL Philosophy]
