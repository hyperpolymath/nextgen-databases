...
| **Injection Attacks**
| GQL injection, parameter tampering
...
# Output:
# API Key: lith_sk_live_abc123...xyz789
# Key ID: key_01234567
...
curl -H "X-Lith-API-Key: lith_sk_live_abc123...xyz789" \
  https://lith.example.com/v1/query

# In GQL session
lith shell --api-key "lith_sk_live_abc123...xyz789"
----
...
Lith uses parameterized queries to prevent GQL injection:
