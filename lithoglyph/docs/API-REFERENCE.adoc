...
The Lith Query Language (GQL) is the primary interface for interacting with Lith. See link:../spec/gql.adoc[GQL Specification] for the complete grammar.
...
* link:../spec/gql.adoc[GQL Specification] - Complete GQL grammar
