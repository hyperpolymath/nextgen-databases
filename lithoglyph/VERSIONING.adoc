...
* GQL advanced syntax (TRAVERSE depth options, complex WHERE clauses)
...
GQL syntax is versioned at the dialect level:

[source,gql]
----
-- Explicitly request GQL v1 syntax
#gql-version 1
...
For GQL syntax changes:

[source,bash]
----
# Check queries for deprecated syntax
lith lint --queries queries/*.gql

# Auto-fix where possible
lith lint --fix --queries queries/*.gql

# Generate migration report
lith lint --report queries/*.gql > migration-report.md
----
...
| GQL v1 | Lith 1.x | Yes
| GQL v1 | Lith 2.x | Yes (with version directive)
| GQL v1 | Lith 3.x | Yes (with version directive)
|===
...
| 0.1.0
| PoC Complete
| Single-node CRUD, journal, basic GQL

| 0.5.0
| Alpha
| Full GQL, constraints, edges
