...
/**
 * Lith GQL Property Tests
 *
 * Property-based tests for GQL parser and query engine
 */
...
/** Run all GQL property tests */
let runGQLProperties = (~config: propertyConfig=defaultConfig): suiteSummary => {
  let tests = [
    (
