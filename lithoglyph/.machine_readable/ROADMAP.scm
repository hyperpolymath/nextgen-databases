  ...
  (critical-path
    ...
    (phase (id "P2") (name "User-Facing Tools")
      ...
      (projection-layer-tasks
        (task "lithoglyph-geo: Integration test with real Lith" priority: high status: pending)
        (task "lithoglyph-geo: Docker deployment" priority: medium status: pending)
        (task "lithoglyph-analytics: Integration test with real Lith" priority: high status: pending)
