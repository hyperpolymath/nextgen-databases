...
Lith is in active development. The core Forth implementation (Form.Blocks, Form.Model) is functional. The FQL runtime and higher layers are being built. This quickstart demonstrates the intended workflow.
====
