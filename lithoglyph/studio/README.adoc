...
[.lead]
*Zero-friction interface for Lith with dependently-typed FBQL.*
...
Lith Studio is a graphical interface that lets non-technical users create and query Lith databases using FBQLdt (dependently-typed Lith Query Language) without needing to understand dependent types, proofs, or Lean 4.
...
├─────────────────────────────────────────────────────────────┤
│  FBQLdt (github.com/hyperpolymath/gqldt)                     │
│  ├── Lean 4 type checker                                    │
...
See https://github.com/hyperpolymath/lithoglyph/blob/main/spec/self-normalizing.adoc[Lith Self-Normalizing Spec] and https://github.com/hyperpolymath/gqldt/blob/main/spec/normalization-types.md[FBQLdt Normalization Types].
