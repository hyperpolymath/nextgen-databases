...
This document specifies the **formal operational semantics** and **static type system** for VeriSim Query Language (VCL). VCL has two execution paths with different semantic guarantees:
