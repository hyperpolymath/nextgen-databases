...
VeriSimDB uses its own query language, *VCL* (VeriSim Query Language),
...
=== VCL-DT (Formally Verified Queries)

VCL-DT extends VCL with proof certificates. Every result includes a
...
NOTE: VCL-DT proof generation is under active development. The syntax
