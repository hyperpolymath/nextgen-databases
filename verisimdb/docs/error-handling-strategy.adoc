...
[source,bash]
----
verisim query --verbosity=verbose query.vcl
verisim query --verbosity=silent query.vcl  # CI/CD mode
----
...
[source,bash]
----
verisim query --no-warnings query.vcl
----

**Suppress hints:**
[source,bash]
----
verisim query --no-hints query.vcl
----

**Strict mode (warnings as errors):**
[source,bash]
----
verisim query --strict query.vcl
...
VCL error handling will integrate with **miniKanren** (link:minikanren-integration-v3.adoc[see roadmap]) to:
...
- link:../src/vcl/VCLError.res[VCL Error Types]
