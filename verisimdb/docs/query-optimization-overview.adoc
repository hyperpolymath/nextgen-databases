...
- link:vcl-architecture.adoc[VCL Architecture] - Dual-path router design
- link:vcl-examples.adoc[VCL Examples] - 35+ example queries
...
- link:../src/vcl/VCLExplain.res[EXPLAIN Implementation] - Source code
