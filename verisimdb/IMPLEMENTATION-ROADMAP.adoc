...
**Integration**:
- ReScript VCL parser → Rust execution engine
...
- `VCL-TUTORIAL.adoc` - 10 example queries
...
=== Fuzz Tests
```bash
cargo fuzz run fuzz_vcl -- -max_total_time=300
```
