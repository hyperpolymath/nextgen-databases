...
**Resolution:** Implement sanctify integration after VCL-DT (issue 5) is resolved, since ZKP proof generation depends on the dependent type checking pipeline being functional.
