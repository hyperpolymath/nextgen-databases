...
// Replace nextgen-databases, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= nextgen-databases — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining nextgen-databases for
...
podman build -t nextgen-databases .
----
...
* Upstream: https://github.com/hyperpolymath/nextgen-databases/issues
