...
Status: PARTIAL DONE — lithoglyph (819 files, 2026-07-27) and verisimdb (713 files, 2026-08-03) DONE with pointer READMEs and split-history tags; gnpl (125 files) and glyphbase (130 files) DONE via un-nest; remaining quandledb/, nqc/, typeql-experimental/, verisim-core/, verisim-modular-experiment/ grandfathered pending GitHub scope expansion. Updated 2026-09-25 with foundational fixes for #42, #45, #53.
Baseline: main @ 8c26b8f. Step-by-step agent command sheet: `RESITE-CODEX-HANDOFF.adoc`. See also `LITHOGLYPH-GNPL-DISENTANGLEMENT.adoc` (2026-09-25) and `FOUNDATIONAL-FIXES-2026-09-25.adoc`.
