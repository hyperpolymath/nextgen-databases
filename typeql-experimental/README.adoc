...
[cols="1,2,2"]
|===
|Extension |VCL-UT Syntax |Idris2 Mechanism
...
|Complete
|Delta EBNF extending VCL v3.0

|Examples (7 .vclut files)
|Complete
...
* **ReScript** (`src/parser/`) — Parser and surface syntax. Consistent with
  existing VCL parser patterns in VeriSimDB. Handles parsing and surface-level
  validation.
