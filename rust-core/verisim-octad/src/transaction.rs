...
//! ACID Transaction Manager for VeriSimDB Octad Operations
//!
//! Provides cross-modality atomicity for octad operations. A octad update must
//! either succeed across all 8 modalities (octad) or fail completely,
//! preserving the fundamental consistency guarantee of the octad model.
//!
//! # Architecture
//!
...
/// All eight modalities that a octad spans (the octad).
///
...
/// The central transaction manager for VeriSimDB octad operations.
///
