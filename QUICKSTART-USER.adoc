...
// Replace nextgen-databases, Nextgen Databases — See README.adoc for details., just run, Nextgen Databases started successfully. with actuals
= nextgen-databases — Quick Start for Users
:toc:
:toclevels: 2

== What is nextgen-databases?

Nextgen Databases — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./nextgen-databases-portable
----
...
[source]
----
Nextgen Databases started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/nextgen-databases/wiki
