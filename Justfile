...
# Justfile for nextgen-databases
...
help-me:
    @echo "=== nextgen-databases Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/nextgen-databases/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: nextgen-databases"
