...
| https://github.com/hyperpolymath/lithoglyph[lithoglyph] (canonical; reservation `lithoglyphdb` exists but `lithoglyph` is live — see `docs/migration/LITHOGLYPH-GNPL-DISENTANGLEMENT.adoc`), https://github.com/hyperpolymath/glyphbase[glyphbase], https://github.com/hyperpolymath/gnpl[gnpl]
| Narration/projection: accounts, stances, warrants and rival interpretations. LithoglyphDB is journal/storage/reversibility; GNPL is narration/projection language layered over GQLdt; Glyphbase is AirTable-like application surface. See `LITHOGLYPH-GNPL-DISENTANGLEMENT.adoc` for design decision.
| QuandleDB / KRL
